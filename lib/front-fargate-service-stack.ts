...
export class FrontFargateServiceStack extends Stack {
    ...
    constructor(scope: Construct, id: string, cluster: Cluster, props?: StackProps) {
        ...
        const image = ContainerImage.fromRegistry('yumaeda/kojinten-front')
        const albSvc = new ApplicationLoadBalancedFargateService(this, 'KojintenFrontService', {
            cluster,
            cpu: 256,
            desiredCount: 1,
